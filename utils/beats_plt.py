...
if __name__ == "__main__":
    ...
    HOP_LENGTH = 512
    SR = FPS * HOP_LENGTH
    y, sr = librosa.load('./aist_plusplus_final/all_musics/mPO1.wav', sr=SR)
    ...
    motion_result = "./experiments/motion_gpt_new/vis/pkl/ep000080/gPO_sBM_cAll_d11_mPO1_ch02.json.pkl.npy"
